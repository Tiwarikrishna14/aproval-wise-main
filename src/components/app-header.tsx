    ...
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/85 px-4 backdrop-blur-md sm:px-6">
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-3">
          ...
          <Badge variant="secondary" className="hidden sm:inline-flex bg-secondary text-secondary-foreground text-[11px] font-medium">
            Acme Retail Pvt. Ltd.
          </Badge>
        </div>
      </div>
      ...
      <Link to="/faq" className="hidden sm:grid h-9 w-9 place-items-center rounded-md text-muted-foreground hover:bg-surface hover:text-foreground">
        <HelpCircle className="h-4.5 w-4.5" />
      </Link>
      <Link to="/notifications" className="relative grid h-9 w-9 place-items-center rounded-md text-muted-foreground hover:bg-surface hover:text-foreground">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center gap-2.5 rounded-md pl-1 pr-2 h-10 hover:bg-surface">
          <Avatar className="h-8 w-8">
            <AvatarFallback className="bg-primary/15 text-primary text-xs font-semibold">RS</AvatarFallback>
          </Avatar>
          <div className="hidden md:block text-left leading-tight">
            <div className="text-[13px] font-medium">Rahul Sharma</div>
        ...
        <DropdownMenuContent align="end" className="w-56">
          <DropdownMenuLabel>
            ...
            <div className="text-xs text-muted-foreground">rahul@acmeretail.in</div>
          </DropdownMenuLabel>
          <DropdownMenuSeparator />
          ...
          <DropdownMenuItem asChild><Link to="/faq">Help center</Link></DropdownMenuItem>
          <DropdownMenuSeparator />
